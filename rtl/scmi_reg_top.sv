...
module scmi_reg_top #(
  ...
  assign channel_status_we = addr_hit[1] & reg_we & !reg_error;
  ...
  assign channel_flags_we = addr_hit[4] & reg_we & !reg_error;
  ...
  assign message_header_we = addr_hit[6] & reg_we & !reg_error;
  ...
  assign doorbell_we = addr_hit[8] & reg_we & !reg_error;

  assign doorbell_intr_wd = reg_wdata[0];

  assign doorbell_preserve_mask_wd = reg_wdata[31:1];
  assign completion_interrupt_we = addr_hit[9] & reg_we & !reg_error;
